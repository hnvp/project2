...
if nargin<5||isempty(a),a = 10;end %nargin returns the number of function input arguments
...
beta = Omega/(2*b*(2*b*m + Omega)); % as delta in IEEE TVT paper
lambda = 1/(2*b);  %as beta in IEEE TVT paper
